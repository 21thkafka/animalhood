...
import com.animal.animalhood.config.oauth.OAuth2AuthorizationRequestBasedOnCookieRepository;
import com.animal.animalhood.config.oauth.OAuth2SuccessHandler;
import com.animal.animalhood.config.oauth.OAuth2UserCustomService;
import com.animal.animalhood.repository.RefreshTokenRepository;
import com.animal.animalhood.service.MemberService;
import com.animal.animalhood.service.UserService;
...
public class WebOAuthSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        //토큰 재발급 URL은 인증 없이 접근 간으하도록 설정, 나머지 API URL은 인증필요
